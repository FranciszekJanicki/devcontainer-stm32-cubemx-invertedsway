...
typedef struct {
    __IO uint32_t CSR; /*!< COMP control and status register, used for bits common to several COMP instances, Address
                          offset: 0x00 */
} COMP_Common_TypeDef;
...
typedef struct {
    ...
    __IO uint32_t APB1SMENR1; /*!< RCC APB1 peripheral clocks enable in sleep mode and stop modes register 1, Address
                                 offset: 0x78 */
    __IO uint32_t APB1SMENR2; /*!< RCC APB1 peripheral clocks enable in sleep mode and stop modes register 2, Address
                                 offset: 0x7C */
    __IO uint32_t
...
#define IS_TIM_INSTANCE(INSTANCE)                                                                     \
    (((INSTANCE) == TIM1) || ((INSTANCE) == TIM2) || ((INSTANCE) == TIM6) || ((INSTANCE) == TIM15) || \
     ((INSTANCE) == TIM16))
...
#define IS_TIM_CC1_INSTANCE(INSTANCE) \
    (((INSTANCE) == TIM1) || ((INSTANCE) == TIM2) || ((INSTANCE) == TIM15) || ((INSTANCE) == TIM16))
